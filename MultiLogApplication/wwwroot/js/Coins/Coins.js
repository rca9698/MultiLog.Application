...
$(document).on('click', '#DesitCoins', function () {
    ...
    $.ajax({
        ...
        success: function (result) {
            ToasteRMessage(result,'#closePaymentModesModal');
        }
    });
});
...
function DepositCoins() {
    ...
    $.ajax({
        ...
        data: obj,
        success: function (result) {
            ToasteRMessage(result,'#DepositCoinsModal');
        }
    });
}
...
function WithDrawCoinsRequest() {
    ...
    $.ajax({
        ...
        data: obj,
        success: function (result) {
            ToasteRMessage(result,'#WithdrawCoinsRequestModal');
        }
    });
}
...
function DepositeCoinsToAccount() {
    ...
    $.ajax({
        ...
        data: obj,
        success: function (result) {
            ToasteRMessage(result,'#DepositeCoinsToAccountModal');
        }
    });
}
...
function WithdrawCoinsFromAccount() {
    ...
    $.ajax({
        ...
        data: obj,
        success: function (result) {
            ToasteRMessage(result,'#withdrawCoinsFromAccountModal');
        }
    });
}
//End function region
                ...
                coins: {
                    validators: {
                        ...
                        callback: {
                            ...
                            callback: function (value, validator, $field) {
                                if ($('#WithdrawCoinsRequestModalForm .coins').val() != '' && ($('#WithdrawCoinsRequestModalForm .coins').val() < parseInt(100) || $('#WithdrawCoinsRequestModalForm .coins').val() > accountCoins))
                                    return false;
                                return true;
                            }
                        }
